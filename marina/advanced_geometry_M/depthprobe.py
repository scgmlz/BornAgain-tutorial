...
#  depth position span
z_min = -300 * nm  # 300 nm to the sample and substrate
...
def get_simulation():
    ...
    simulation.addParameterDistribution("*/Beam/InclinationAngle", alpha_distr, n_points, n_sig)

    # add wavelength divergence
    wl_distr = ba.DistributionGaussian(wl, d_wl/fwhm2sigma)
    simulation.addParameterDistribution("*/Beam/Wavelength", wl_distr, n_points_wl, n_sig_wl)
