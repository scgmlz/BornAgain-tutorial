"""
Ag nanoparticles in polymer layers measured at GALAXY
"""
...
# detector setup as given from instrument scientist
pilatus_npx, pilatus_npy = 981, 1043
pilatus_pixel_size = 0.172  # in mm

# parameters obtained from AgBH calibration measurements
detector_distance = 1730.0  # sample-detector distance, mm
beam_xpos, beam_ypos = 597.1, 323.4  # direct beam position, pixels

# path to the file with experimental data
data_filename = "galaxi_data.tif.gz"
